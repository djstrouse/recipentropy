function [] = RecipEntropyCulturesConsolidate(culture,Ningred_used,orders,Nsubsamps)
% Consolidates subsamples for order-order maxent model of Ningred_used most
% common ingredients in recipes from a specified culture
%
...
for o = orders
  ...
  cd(['data/cultures/',culture_str,sprintf('/%iingred/order%i',Ningred_used,o)]);
  if o==0 % raw freqs
