...
Nsubsamp = 1;
subsamp_idx = 1;
diary(sprintf('recipentropy%i_diary.txt',Ningred_used));
...
save_data = false; % indicates whether to save data
...
if save_data
  save(...
    sprintf('data/recipentropy_%iin_subsamp%i_small.mat',Ningred_used,subsamp_idx),...
    'maxent1_small',...
    'maxent2_small',...
    ...
    '-v7.3');
  save(...
    sprintf('data/recipentropy_%iin_subsamp%i_large.mat',Ningred_used,subsamp_idx),...
    'maxent1_large',...
    'maxent2_large',...
