...
Ningred_used = 10;
Nsubsamp = 25;
diary(sprintf('recipentropymeats%i_diary.txt',Ningred_used));
load('data/meats.mat');
...
if save_data
  save(...
      sprintf('data/recipentropymeats_%iin_small.mat',Ningred_used),...
      'maxent1_small',...
      'maxent2_small',...
      ...
      '-v7.3');
  save(...
      sprintf('data/recipentropymeats_%iin_large.mat',Ningred_used),...
      'maxent1_large',...
      'maxent2_large',...
